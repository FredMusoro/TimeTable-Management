...
def create_table():
    ...
    name = input()
    print ('name')
    check = check_table(name)
    print (check)
    if check == 0:
        connection.execute('create table '+name+' (Id INT NOT NULL AUTO_INCREMENT,Day varchar(30), Slot varchar(30), Location varchar(30), Batch varchar(30), Subject varchar(30), Faculty varchar(100), PRIMARY KEY (Id) )')
        ...
        return 'Bro table already exists.'
